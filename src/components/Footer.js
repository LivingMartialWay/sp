    ...
    <div className="footer">
      ...
      <div class="row">
            <div class="footer__navigation">
                  ...
                  <a class="ztn ztn-icon ztn-pinterest"><i class="fa fa-envelope"></i><span>LivingMartialWay@gmail.com</span></a>
                  ...
                  <a class="ztn ztn-icon ztn-twitter"><i class="fa fa-phone"></i><span>+972.58.420.2138</span></a>
